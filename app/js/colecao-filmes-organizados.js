...
ColecaoFilmesOrganizados.prototype.render = function() {
  ...
  $.each(this.filmesOrganizados, function(k, v) {
    // categorias
    $("#listaFilmes").append(
        `<div class="swiper-container filmes-` + k + `">
    ...
    $.each(Object.values(v), function() {
      $.each(this, function(index, filme) {
        var swiper = new Swiper(`.swiper-container.filmes-` + k + ``, {
          slidesPerView: 6,
          spaceBetween: 10,
          freeMode: true,
          navigation: {
        ...
        $(`.filmes-` + k + ` > .swiper-wrapper`).append(
          `<div class="swiper-slide">
                    <img class="rounded" src="` + filme.images[0].url + `" alt=` + filme.title + `">
